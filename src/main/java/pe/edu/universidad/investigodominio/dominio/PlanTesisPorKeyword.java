...
@Entity
@DynamicInsert
public class PlanTesisPorKeyword {
    @Id
    @GeneratedValue(generator="plan_tesis_por_keyword_id_seq")
    @SequenceGenerator(name="plan_tesis_por_keyword_id_seq",sequenceName="plan_tesis_por_keyword_id_seq", allocationSize=1)
    private Integer id;
